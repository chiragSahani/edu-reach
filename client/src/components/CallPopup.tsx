        ...
        {status === "error" && (
          <div className="text-center py-10">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4 text-sm text-gray-600">
              <p className="font-medium text-gray-700 mb-1">Reach us directly:</p>
              <p>Phone: <a href="tel:+919876543210" className="text-maroon font-medium">+91-9876543210</a></p>
              <p>Email: <a href="mailto:admissions@edureach.edu.in" className="text-maroon font-medium">admissions@edureach.edu.in</a></p>
            </div>
            <button
              onClick={reset}
