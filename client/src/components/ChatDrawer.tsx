...
export default function ChatDrawer({ open, onClose }: ChatDrawerProps) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-2rem)] h-[520px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200"
